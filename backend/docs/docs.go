...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/posts/pending": {
            "get": {
                ...
                "description": "管理员分页获取所有待审核帖子列表，支持关键词搜索",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "model.PostStatus": {
            ...
            "x-enum-comments": {
                "PostStatusDraft": "草稿",
                "PostStatusHidden": "已隐藏（审核拒绝 或 管理员操作）",
                "PostStatusPending": "待审核（命中 review 级敏感词 或 举报聚合触发）",
                "PostStatusPublished": "已发布"
            },
            "x-enum-descriptions": [
                "草稿",
                "待审核（命中 review 级敏感词 或 举报聚合触发）",
                "已发布",
                "已隐藏（审核拒绝 或 管理员操作）"
            ],
            "x-enum-varnames": [
