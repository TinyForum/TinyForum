...
// @Success 200 {object} response.Response{data=do.Board} "创建成功"
...
// @Param body body board.CreateBoardInput true "板块信息"
// @Success 200 {object} response.Response{data=do.Board} "更新成功"
...
// @Produce json
// @Param id path int true "板块ID"
// @Success 200 {object} response.Response{data=do.Board} "获取成功"
// @Failure 400 {object} response.Response "无效的板块ID"
// @Failure 404 {object} response.Response "板块不存在"
...
// @Success 200 {object} response.Response{data=response.PageData{list=[]do.Board}} "获取成功"
...
// @Tags 板块管理
// @Produce json
// @Success 200 {object} response.Response{data=[]do.BoardTree} "获取成功"
// @Failure 500 {object} response.Response "服务器内部错误"
