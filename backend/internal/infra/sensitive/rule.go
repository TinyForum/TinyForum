...
// 敏感词级别
const (
	// 【pass 直接通过】【0 – 20】安全无害，无任何敏感词命中或命中的词语无害（如白名单）
	LevelNormal Level = "Normal"
	// 【可记录，通常 pass 或 review（视策略）】【21 – 50】存在轻微风险，可能命中低分规则（如轻度广告、擦边词），但不构成明显违规
	LevelLow Level = "Low"
	// 【一般触发 review 人工审核】【51 – 80】存在明显风险，命中多条中等分规则或一条高分类内容（如医疗功效、轻度政治）
	LevelMedium Level = "Medium"
	// 【通常 block 直接拦截】【81 – 100】高风险，命中明确违规内容（如赌博、诈骗、色情），大概率违规
	LevelHigh Level = "High"
	// 【强制 block，优先处置】【>100】极其严重违规，如多条高权重规则同时命中，或黑名单强制匹配
