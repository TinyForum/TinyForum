...
func ModeratorRequired(jwtMgr *jwt.JWTManager, boardRepo boardRepo.BoardRepository) gin.HandlerFunc {
...
func CanDeletePost(jwtMgr *jwt.JWTManager, boardRepo boardRepo.BoardRepository) gin.HandlerFunc {
	return SpecificModeratorPermission(jwtMgr, boardRepo, "delete_post")
}

// CanPinPost 检查是否有置顶帖子的权限
func CanPinPost(jwtMgr *jwt.JWTManager, boardRepo boardRepo.BoardRepository) gin.HandlerFunc {
	return SpecificModeratorPermission(jwtMgr, boardRepo, "pin_post")
}

// CanEditAnyPost 检查是否有编辑任何帖子的权限
func CanEditAnyPost(jwtMgr *jwt.JWTManager, boardRepo boardRepo.BoardRepository) gin.HandlerFunc {
	return SpecificModeratorPermission(jwtMgr, boardRepo, "edit_any_post")
}

// CanManageModerator 检查是否有管理版主的权限
func CanManageModerator(jwtMgr *jwt.JWTManager, boardRepo boardRepo.BoardRepository) gin.HandlerFunc {
	return SpecificModeratorPermission(jwtMgr, boardRepo, "manage_moderator")
}

// CanBanUser 检查是否有禁言用户的权限
func CanBanUser(jwtMgr *jwt.JWTManager, boardRepo boardRepo.BoardRepository) gin.HandlerFunc {
