...
// func (r *repository) FindDuplicate(ctx context.Context, fileHash string, fileType do.FileType) (*do.Attachment, error) {
//     var att do.Attachment
//     err := r.db.WithContext(ctx).
...
//	func (r *repository) Update(ctx context.Context, att *do.Attachment) error {
