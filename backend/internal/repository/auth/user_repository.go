...
func (r *authRepository) FindByEmail(ctx context.Context, email string) (*do.User, error) {
	var user do.User
...
func (r *authRepository) FindByResetToken(ctx context.Context, token string) (*do.RefreshToken, error) {
...
func (r *authRepository) GetUserByResetToken(ctx context.Context, token string) (*do.User, error) {
...
func (r *authRepository) Update(ctx context.Context, user *do.User) error {
	return r.db.WithContext(ctx).Save(user).Error
}

func (r *authRepository) Save(ctx context.Context, user *do.User) error {
