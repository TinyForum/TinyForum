...
//	func (r *pluginRepository) ListByAuthorID(ctx context.Context, authorID int64) ([]*do.PluginMeta, error) {
//	    var plugins []*do.PluginMeta
//	    err := r.db.WithContext(ctx).Where("author_id = ?", authorID).Find(&plugins).Error
//	    return plugins, err
//	}
package plugin