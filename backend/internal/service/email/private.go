...
func (s *emailService) renderResetPasswordTemplate(templateName string, data vo.ResetPasswordEmailDataHtml) (string, error) {
...
func (s *emailService) buildSimpleResetEmail(data vo.ResetPasswordEmailDataHtml) string {
