...
import { usePublishedAnnouncements } from "@/features/announcements/hooks/usePublishedAnnouncements";
...
export default function AnnouncementsClient() {
  ...
  // 查询：分页获取已发布公告列表
  const { data, isLoading: loading } = usePublishedAnnouncements(
    page,
    pageSize,
  );
