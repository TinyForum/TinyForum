...
import {
  useBoardBySlug,
  useBoardPostsBySlug,
} from "@/features/boards/hooks/useBoard";
...
export default function BoardDetailClient({ slug }: { slug: string }) {
  ...
  // 查询帖子列表 - 修复类型问题
  const { data: postsData, isLoading: loadingPosts } = useBoardPostsBySlug(
    slug,
