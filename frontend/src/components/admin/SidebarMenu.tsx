...
export function SidebarMenu({
  ...
  const menuItems = [
    ...
    {
      id: "moderators_management",
      label: t("moderators_management"),
      icon: User2Icon,
      color: "text-info",
    },
    {
      id: "posts",
      label: t("post_management"),
      icon: FileText,
      color: "text-success",
    },
    {
      id: "qa",
      label: t("qa_management"),
      icon: HelpCircle,
  ...
  return (
    <div
      className={`bg-base-200 border-r border-base-300 transition-all duration-300 ${collapsed ? "w-20" : "w-64"} flex flex-col`}
    >
      {/* Logo 区域 */}
