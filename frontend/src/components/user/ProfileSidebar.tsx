    ...
    <div className="card bg-base-100 border border-base-300 shadow-sm">
      ...
      <div className="card-body pt-0">
        ...
        <div className="grid grid-cols-3 gap-2 py-4 border-y border-base-200 my-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-primary">{profile.score ?? 0}</div>
        ...
        <div className="mt-4">
          {isSelf ? (
            <Link href="/settings" className="btn btn-outline btn-sm w-full gap-2">
            ...
            <Link href="/auth/login" className="btn btn-outline btn-sm w-full gap-2">
              {t("login_to_follow")}
            </Link>
          )}
        </div>
